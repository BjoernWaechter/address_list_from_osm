...
class TestGeoJoin:
    ...
    def test_nearest_point_to_point(self, test_context):
        ...
        for s2_level in S2_TEST_LEVEL:
            print(f"s2_level: {s2_level}")
            ...
            ], f"S2 Level {s2_level} failed"

    def test_nearest_poly_to_poly(self, geo_join_context):
